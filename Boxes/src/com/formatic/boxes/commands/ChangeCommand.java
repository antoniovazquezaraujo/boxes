...
public class ChangeCommand extends Command {
	...
	public final static int GRADIENT_COLOR_FROM_R = 12;
	public final static int GRADIENT_COLOR_FROM_G = 13;
	public final static int GRADIENT_COLOR_FROM_B = 14;
	public final static int GRADIENT_COLOR_TO_R = 15;
	public final static int GRADIENT_COLOR_TO_G = 16;
	public final static int GRADIENT_COLOR_TO_B = 17;
	float fromValue;
	float actualValue;
	float toValue;
	float delta;
